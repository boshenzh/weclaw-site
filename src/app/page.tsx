...
const featuredChineseResources = [
  {
    ...
    desc: "深圳某中型海运货代用 3 天集训营上线 OpenClaw 私有 AI 助手，已稳定运行 6 个月以上。真实数据、做到的、做不到的全公开。",
    href: "/case/huodai-baojia-speed-to-lead",
  },
  {
    title: "场景演示：一行公司名 → 客户画像 + 自动开发信（视频）",
    desc: "把一行公司名交给 OpenClaw 助手，它自动调研公司、对照运价表算匹配度、起草个性化中文开发信、走 SMTP 发送。约 2 分 45 秒视频演示。",
