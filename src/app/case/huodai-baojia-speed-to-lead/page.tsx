...
export const metadata: Metadata = {
  ...
  description:
    "深圳某中型海运货代通过喂龙虾部署 OpenClaw 私有 AI 员工，把报价响应从行业均值 90 小时压到 15 分钟。3 天线下集训营交付，已稳定运行 6 个月以上。本文公开真实数据、做到的、做不到的、定价区间。",
  keywords: [
    "货代 AI 案例",
    "货代 AI 助手案例",
    "海运货代 AI 员工",
  ...
  openGraph: {
    ...
    description:
      "深圳某中型海运货代用 OpenClaw 私有 AI 员工压缩报价响应时长。真实数据、做到的、做不到的、定价区间全公开。",
    url: PAGE_URL,
    type: "article",
    locale: "zh_CN",
  ...
  twitter: {
    ...
    description: "深圳某中型海运货代用 OpenClaw 私有 AI 员工压缩报价响应时长。",
    site: "@boshenzh",
    creator: "@boshenzh",
  },
};
...
const whatWeBuilt = [
  {
    title: "1 · 监听询价",
    body: "AI 员工 7×24 监听客户授权接入的微信群、企业微信、QQ 群、收件箱。识别「询价」意图后立即触发整理流程。",
  },
  {
    title: "2 · 自动整理运价",
  ...
  {
    title: "4 · 自动按客户分类跟进",
    body: "新询价 6 小时未回 / 报价后 24 小时未确认 / 老客户 30 天没询价：AI 员工按客户的偏好风格起草跟进消息，销售确认后再发送。",
  },
  {
    title: "5 · ROI 仪表盘",
...
const honest = [
  ...
  "我们不是「替代销售」，定位是「销售助理」——处理询价识别、运价整理、报价单初稿、跟进提醒这些重复工作；关键报价、对外发送和业务判断仍由销售确认",
];
...
export default function CaseHuodaiPage() {
  const caseStudyJsonLd = {
    ...
    description:
      "深圳某中型海运货代通过喂龙虾部署 OpenClaw 私有 AI 员工，把报价响应中位数从行业均值 90 小时压缩到约 15 分钟。3 天线下集训营交付，已稳定运行 6 个月以上。",
    url: PAGE_URL,
    ...
    <main className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <section className="border-b border-zinc-200 bg-white">
        <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-lg text-zinc-600">
            ...
            这家深圳货代通过喂龙虾部署 OpenClaw 私有 AI 员工，把这条 speed-to-lead 曲线翻了过来。
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-zinc-200">
        <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-zinc-600">
            诚实说明 AI 员工现在做不到、或偶尔会错的地方。它适合先处理重复、可审核、可留痕的工作；报价、对外承诺和异常场景仍保留人工确认。
          </p>
